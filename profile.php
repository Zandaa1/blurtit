...
<html lang="en">
  ...
  <body class="bg-gray-100">
    ...
    <h1 class="text-2xl text-center font-semibold">Hey, <?php echo htmlspecialchars($user_nickname); ?>!</h1>
...
<a href="logout.php">
    ...
    <button onclick="confirmDeleteAccount()" class="mt-2 w-full py-3 bg-white border-2 border-red-500 text-red-500 font-bold rounded-xl hover:bg-red-50 active:bg-red-100 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Delete Account</button>
      </main>
    ...
    <script>
      ...
      function confirmDeleteAccount() {
        const confirmed = confirm(
          ...
          "• All your session history and data\n" +
          "• Everything associated with your account\n\n" +
          "Click 'OK' to continue to the deletion page, or 'Cancel' to keep your account."
        );
